...
namespace Dio
{
    public class DioCheckBox : CheckBox
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            {
                g.DrawRectangle(foreColorPen, 0, 0, 14, 14);
                g.DrawRectangle(overlayPen, 0, 0, 14, 14);
                if (Checked)
                {
                    g.SetClip(new Rectangle(3, 3, 9, 9));
                    g.FillRectangle(backColorBrush, 2, 2, 10, 10);
